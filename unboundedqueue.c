...
//       ovviamente il rischio e' quello di leggere un valore non aggiornato, ma
//       nel caso di piu' produttori e consumatori la lunghezza della coda per
//       un thread e' comunque un valore "non affidabile" se non all'interno di
//       una transazione in cui le varie operazioni sono tutte eseguite in mutua
//       esclusione.
